...
const Skills = ({ skills }: Props) => {
  return (
      <motion.div
        ...
        <h3 className='absolute top-24 xs:top-16 uppercase tracking-[20px] text-gray-500 text-2xl'>
            Skills
        </h3>

        <h3 className='absolute top-36 xs:top-28 uppercase tracking-[3px] text-gray-500 text-sm'>Hover over a skill for current proficiency</h3>
